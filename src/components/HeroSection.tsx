      ...
      <AnimatePresence>
        {!isVideoLoaded && (
          ...
          >
            ...
            >
              <h1 
                className="font-light uppercase tracking-[0.2em] text-white/80 leading-relaxed"
              ...
              <div className="mt-8 flex justify-center gap-2">
                <motion.div 
                  className="w-1.5 h-1.5 rounded-full bg-[#D7E2EA]/40"
                  animate={{ y: [0, -5, 0] }}
                  transition={{ duration: 1, repeat: Infinity, delay: 0 }}
                />
                <motion.div 
                  className="w-1.5 h-1.5 rounded-full bg-[#D7E2EA]/60"
                  animate={{ y: [0, -5, 0] }}
                  transition={{ duration: 1, repeat: Infinity, delay: 0.2 }}
                />
                <motion.div 
                  className="w-1.5 h-1.5 rounded-full bg-[#D7E2EA]/80"
                  animate={{ y: [0, -5, 0] }}
